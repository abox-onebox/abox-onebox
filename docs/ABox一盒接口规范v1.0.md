...
| P34 | 财务结算 | M35 | D33–D46（**已实装** D33–D35 资金总览/佣金/佣金入账（M3-13）· D36/D37 应付结算 · D40–D42 退款审批；**待落点** D38–D39 余额调整 · D43 对账 · D44 发票） | `ab_commission`、`ab_supplier_share`、`ab_refund` |
