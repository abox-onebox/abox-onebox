...
| 现行资产 | 29 份 |
| 已废弃资产 | 7 份（存档，勿参考） |
| 工程骨架 | `abox-onebox/` · **501 个文件**（阶段四产出） |
...
| 15 | `ABox一盒开发里程碑计划v1.0.md` | M1–M5 里程碑 + W1–W10 甘特 + 验收标准 + 风险登记册（阶段四） | 86,393 | `f0e3eae0cd1d` |
| 16 | `ABox一盒接口规范v1.0.md` | 接口契约（阶段二）· 60+ 端点 / 错误码 / 幂等 · 2026-09-16 S9 应付结算改「采购应付」口径 | 202,103 | `2a4066085beb` |
...
| 22 | `ABox一盒订单状态机与全链路流转v1.0.md` | 订单域行为契约（阶段二）· 11 态 / 8 定时任务 / C6 退款三段式 / C11 出款通道 | 28,357 | `84d6680bcdf8` |
...
| 37 | `apps/api-server/src/modules/finance/commission.service.ts` |  | 40,103 | `9752daad8dd1` |
...
| 68 | `scripts/e2e-m3.mjs` |  | 526,567 | `3a3fb5466875` |
...
| 125 | `apps/api-server/src/modules/finance/finance.module.ts` |  | 7,512 | `8a5ca5a4c78d` |
...
| 6 | `tests/baseline_manifest.py` | 本清单生成器（基线变更时重跑） | 104,010 | `574dcd4d51fd` |
