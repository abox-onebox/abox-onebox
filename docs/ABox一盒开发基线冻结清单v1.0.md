...
| 38 | `prototype/manifest.json` | PWA 清单 | 679 | `a339bfd8ca0d` |
...
| 15 | `scripts/gate.mjs` |  | 18,160 | `f34b20d277b7` |
...
| 37 | `apps/api-server/src/modules/finance/commission.service.ts` |  | 43,463 | `86bb82398b20` |
| 38 | `apps/api-server/src/modules/finance/withdraw.service.ts` |  | 8,952 | `3dfa71377d4c` |
| 39 | `apps/api-server/src/modules/finance/refund.service.ts` |  | 49,113 | `249a292829bd` |
...
| 63 | `apps/api-server/src/modules/order/order-admin.controller.ts` |  | 5,846 | `59c9aa93ecbc` |
...
| 156 | `apps/api-server/src/modules/finance/refund.service.ts` |  | 49,113 | `249a292829bd` |
...
| 161 | `apps/api-server/src/modules/finance/finance-admin.controller.ts` |  | 23,130 | `9768b128cba5` |
...
| 187 | `apps/api-server/src/config/app.config.ts` |  | 5,637 | `6b2dd8c1628c` |
...
| 205 | `apps/api-server/src/main.ts` |  | 9,080 | `6b7f5167eaec` |
...
| 230 | `apps/api-server/src/tasks/schedule.registrar.ts` |  | 11,726 | `e4f4d8d76a56` |
| 231 | `apps/api-server/src/common/security/route-audit.ts` |  | 22,611 | `b3524b01fc17` |
| 232 | `apps/api-server/src/common/security/security-scan.ts` |  | 25,724 | `78dcbfa9fd3f` |
...
| 6 | `tests/baseline_manifest.py` | 本清单生成器（基线变更时重跑） | 158,287 | `06102fceb13d` |
