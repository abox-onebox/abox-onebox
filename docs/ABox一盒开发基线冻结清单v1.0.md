...
| 27 | `apps/admin-web/src/constants/index.ts` |  | 4,857 | `58934dbfd03c` |
...
| 50 | `apps/api-server/src/common/constants/admin-role.ts` |  | 5,422 | `e127605cf2f1` |
...
| 53 | `apps/api-server/src/common/constants/error-code.ts` |  | 14,882 | `0c50b8af8c00` |
...
| 90 | `apps/api-server/src/modules/supplier/supplier.module.ts` |  | 2,469 | `4b4e44b63dfa` |
...
| 94 | `apps/api-server/src/database/entities/supplier.entity.ts` |  | 11,993 | `19c44fefa1a9` |
...
| 115 | `apps/api-server/src/modules/supplier/supplier.controller.ts` |  | 4,982 | `1795d00df8c1` |
| 116 | `apps/api-server/src/modules/supplier/dto/supplier.dto.ts` |  | 2,896 | `221fcce297ea` |
| 117 | `apps/admin-web/src/api/supplier-portal.ts` |  | 5,958 | `7d5d8549ea71` |
| 118 | `apps/admin-web/src/views/supplier/workbench.vue` |  | 7,547 | `4c114b9d62b1` |
| 119 | `apps/admin-web/src/views/supplier/cook-confirm.vue` |  | 9,094 | `297e2dbcf19b` |
| 120 | `apps/admin-web/src/views/supplier/packing.vue` |  | 7,432 | `2fcc1097cece` |
| 121 | `apps/admin-web/src/router/routes.ts` |  | 7,733 | `2db569e391a6` |
