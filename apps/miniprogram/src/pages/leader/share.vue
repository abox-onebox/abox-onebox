 ...
 * P19 · 分享中心
 *
 * 数据来源：L2 `GET /leader/share` + L3 `POST /leader/share/qrcode`。
 *
...
import { fetchShareMaterial, generateLeaderQrcode } from '@/api/leader';
import type { LeaderQrcodeData, LeaderShareMaterialData } from '@/api/leader';
