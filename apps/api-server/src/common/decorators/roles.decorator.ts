 ...
 * 勿据此文件判断项目具备该能力。
 *
 * 真实实现：`common/decorators/auth.decorator.ts`（`Roles` / `ADMIN_ROLES_KEY`）
 *
 * 原骨架说明：common/decorators/roles.decorator.ts —— 角色装饰器（@Roles）—— 4 角色：user / leader / supplier / admin · 占位骨架
 *
