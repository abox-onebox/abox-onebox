...
export class Building {
  ...
  @Column({ type: 'decimal', transformer: coordTransformer, precision: 10, scale: 6, nullable: true })
  ...
  @Column({ name: 'building_group_id', type: 'bigint', transformer: bigintTransformer, nullable: true, comment: '所属楼群（ER v2.1 §二）' })
